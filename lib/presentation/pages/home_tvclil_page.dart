...
class HomeTvclilPage 
extends StatefulWidget {

@override
  _HomeTvclilPageState createState() => _HomeTvclilPageState();static const ROUTE_NAME = '/tv';}
 ...
 drawer: Drawer(
   child: Column(
     children: [
        ...
        (currentAccountPicture: CircleAvatar(backgroundImage: AssetImage ('assets/circle-g.png'), ),
   ...
   ListTile(
     ...
     title: Text('TV'), onTap: () { Navigator.pop(context); }, ),
   ExpansionTile(
     title: Text('My Watchlist'),
     leading: Icon(Icons.save_alt),
     children: <Widget>[ListTile(leading: Icon(Icons.movie),
     title: Text('Movie'), onTap: () {Navigator.pushNamed( context, WatchlistMoviesPage.ROUTE_NAME);
  },
),
   ListTile(leading: Icon(Icons.tv),
     title: Text('TV'),onTap: () {Navigator.pushNamed(context, WatchlistTvclilPage.ROUTE_NAME);
    },
  ),
],
),
   ListTile(onTap: () {Navigator.pushNamed(context, AboutPage.ROUTE_NAME); },
      ...
      appBar: AppBar(
      title: Text('TV'),
      actions: [IconButton(onPressed: () {Navigator.pushNamed(context, SearchTvclilPage.ROUTE_NAME);},
    ...
    BlocBuilder<TvOnAirBloc, TvOnAirState>(
       ...
       _buildSubHeading(
          title: 'Popular',onTap: () => Navigator.pushNamed(context, PopularTvclilPage.ROUTE_NAME),),
       ...
       _buildSubHeading(
          title: 'Top Rated',
          onTap: () => Navigator.pushNamed(context, TopRatedTvclilPage.ROUTE_NAME),),
...
class TvList extends StatelessWidget {final List<Tvclil> tv;
 ...
 @override
  Widget build(BuildContext context) {
   ...
   Navigator.pushNamed( context,
    TvclilDetailPage.ROUTE_NAME,arguments: tvs.id, );},
       child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(16)),
       child: CachedNetworkImage(imageUrl: '$BASE_IMAGE_URL${tvs.posterPath}',
