...
class TvclilRepositoryImpl implements TvclilRepository 
{
  final TvclilRemoteDataSource 
  remoteDataSource;
  final TvclilLocalDataSource 
  localDataSource;
  ...
  @override
  Future<Either<Failure, List<Tvclil>>>
   getNowPlayingTv() async 
   {
    try 
    {
      final result = 
      await remoteDataSource.getNowPlayingTv();
      return Right(result.map((model)
  ...
  @override
  Future<Either<Failure, TvclilDetail>>
   getTvDetail(int id) async 
   {
    try
     {
      final result 
      = await remoteDataSource.getTvDetail(id);
  ...
  saveWatchlistTv(TvclilDetail tv) async {
    try 
    {
      final result =
      await localDataSource.insertWatchlistTv(TvclilTable.fromEntity(tv));
      return Right(result);
    } 
  ...
  @override
  Future<Either<Failure, String>> removeWatchlistTv(TvclilDetail tv) async 
  {
    try 
    {
      final result =
      await localDataSource.removeWatchlistTv(TvclilTable.fromEntity(tv));
      return Right(result);
    } 
    on DatabaseException catch (e) 
    {
  ...
  {
    final result = 
    await localDataSource.getTvById(id);
    return result != null;
  }
